<?php
    ...
    $pdf->Cell(55, 10, '', 0, 0);        
    $pdf->Cell(90, 10, 'LAPORAN PEMASOKAN', 0, 0);    
    $pdf->Cell(45, 10, '', 0, 1);
    ...
    $pdf->Cell(50, 10, 'Waktu', 1, 0);
    $pdf->Cell(45, 10, 'Jumlah', 1, 0);
    $pdf->Cell(43, 10, 'Harga', 1, 0);
    $pdf->Cell(45, 10, 'Total Harga', 1, 1);

    $total_barang_suplai = 0;
    $total_pengeluaran = 0;

    $ambil_data = filter_laporan_suplai($mulai, $sampai);
    $i = 1;
    while($data = mysqli_fetch_assoc($ambil_data)){
      ...
      $total_pengeluaran = $total_pengeluaran + $data['total_harga'];
      $total_barang_suplai = $total_barang_suplai + $data['jumlah'];
    }

    $pdf->SetFont('Arial','B', 9);
    $pdf->Cell(120, 10, "Jumlah Barang Dipasok", 1, 0);
    $pdf->Cell(70, 10, format_angka($total_barang_suplai), 1, 1);
    $pdf->Cell(120, 10, "Jumlah Pengeluaran", 1, 0);
    $pdf->Cell(70, 10, rupiah($total_pengeluaran), 1, 1);
